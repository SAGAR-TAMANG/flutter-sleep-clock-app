...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    ..shader = RadialGradient(colors: [Color(0xFF7483F6), Color(0xFF77DDFF)]).createShader(Rect.fromCircle(center: center, radius: radius))
    ..style = PaintingStyle.stroke
    ..strokeCap = StrokeCap.round
    ...
    var hourHandY = centerY + radius * 0.4 * sin(dateTime.hour * 30 * pi / 180);    
